...
class _ApiService implements ApiService {
  ...
  @override
  Future<List<FavoriteResponseModel>> getFavourites() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<FavoriteResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'favourites',
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<FavoriteResponseModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                FavoriteResponseModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  @override
  Future<FavoriteResponseModel> getFavouriteById(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<AddToFavoriteResponseModel> addFavourite(
    ...
    _data.addAll(favoriteRequestModel.toJson());
    final _options = _setStreamType<AddToFavoriteResponseModel>(
