...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<CatBreed> breeds)?  success,TResult Function( ApiErrorModel apiErrorModel)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
return success(_that.breeds);case Failure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<CatBreed> breeds)  success,required TResult Function( ApiErrorModel apiErrorModel)  failure,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case Loading():
return loading();case Success():
return success(_that.breeds);case Failure():
return failure(_that.apiErrorModel);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<CatBreed> breeds)?  success,TResult? Function( ApiErrorModel apiErrorModel)?  failure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Loading implements CatBreedState {
  const Loading();
...
class Success implements CatBreedState {
  const Success(final  List<CatBreed> breeds): _breeds = breeds;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success&&const DeepCollectionEquality().equals(other._breeds, _breeds));
}
...
@override
String toString() {
  return 'CatBreedState.success(breeds: $breeds)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $CatBreedStateCopyWith<$Res> {
...
class Failure implements CatBreedState {
...
@override
String toString() {
  return 'CatBreedState.failure(apiErrorModel: $apiErrorModel)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<$Res> implements $CatBreedStateCopyWith<$Res> {
